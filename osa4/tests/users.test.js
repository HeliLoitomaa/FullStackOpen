...
describe('user methods when there is initially one user at db', () => {
  beforeEach(async () => {
  ...
  test('creation fails with proper statuscode and message without password', async () => {
    const usersAtStart = await usersInDb()
  ...
  test('creation fails with proper statuscode and message with too short password', async () => {
    const usersAtStart = await usersInDb()
